...
import { LocU, Rectangle } from '../../shared/models/temp/counts.data';
...
export class CountsComponent implements OnInit {
  ...
  private drawPoints() {
    this.svg.selectAll(".dot")
      .data(this.scoringAlgorithmService.locusData.values().next().value.CountsData)
      .enter().append("circle")
      .classed("dot", true)
      .attr("r", 2)
      ...
      .on("mouseover", (d) => {
          d3.select(".tooltip-counts")
              .style("opacity", .9);
          d3.select(".tooltip-counts").html(d.tooltipData.data + "<br/>"  +
